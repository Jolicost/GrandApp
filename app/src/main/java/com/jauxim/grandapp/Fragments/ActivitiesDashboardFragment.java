...
import com.jauxim.grandapp.Adapter.ActivitiesAdapter;
...
public class ActivitiesDashboardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new ActivitiesAdapter(getActivity(), activitiesList);
    ...
    private void prepareData(){
        ...
        activitiesList.add(new ActivityModel("https://www.radioactiva.cl/wp-content/uploads/2018/01/abuelos-830x400.jpg", "Baile nocturno", "", 4.3f, "Lucas", new Pair(213, 0)));
